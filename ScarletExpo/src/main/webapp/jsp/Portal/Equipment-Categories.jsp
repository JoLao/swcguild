                ...
                <div class="col-xs-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h2 align="center">Equipment Categories</h2>
                            <hr />
                            <div style="height: 25px"></div>

                            <a href="displayCategories"><button type="button" class="btn btn-default btn-lg btn-block">View All Equipment Categories</button></a>
                            <br />
                            <a href="addCategoryForm"><button type="button" class="btn btn-default btn-lg btn-block">Add New Equipment Category</button></a>
                            <br />
                            <a href="displayCategories"><button type="button" class="btn btn-default btn-lg btn-block">Remove Equipment Categories</button></a>
                            <div style="height: 25px"></div>
                        </div>
                    </div>
                </div>
