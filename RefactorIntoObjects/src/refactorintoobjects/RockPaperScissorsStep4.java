...
public class RockPaperScissorsStep4 {
    ...
    private int tiesCnt = 0;
    private int userWinCnt = 0;
    private int compWinCnt = 0;
    ...
    public int rockPaperScissorsNumValue(String str) {
        int num = 0;
    ...
    public String rockPaperScissorsStrValue(int n) {
        String str = "";
        switch (n) {
            case 1:
                str = "Rock";
    ...
    public String checkWinner(int userNum, int computerNum) {
        String result = "";
    ...
    public String checkWinner1(int userNum, int computerNum) {
        String result = "";
        if (userNum == computerNum) {
            result = "tie";
            tiesCnt++;
    ...
    public void displayOverallStatus() {
