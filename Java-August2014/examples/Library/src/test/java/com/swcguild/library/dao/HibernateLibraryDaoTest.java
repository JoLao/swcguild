 ...
 * @author apprentice
 */
public class HibernateLibraryDaoTest {

    LibraryDao jdbcDao;
    HLibraryDao dao;

    public HibernateLibraryDaoTest() {
    }
    ...
    public void setUp() {
        ...
        jdbcDao = (LibraryDao) ctx.getBean("libraryDao");
        dao = (HLibraryDao) ctx.getBean("hibernateLibraryDao");
    ...
    public void testTest() {
        ...
        System.out.println(fromDB.getBooks().size());
...
//        assertEquals(fromDb.getBooks().size(), 0);
//
//        // Update Test
...
////        jdbcDao.addBook(b);
////        
////        List<Author> aList = jdbcDao.getAuthorsByBookId(b.getBookId());
...
//        dao.addBook(b);
//
//        HBook fromDb = dao.getBookById(b.getBookId());
...
////        jdbcDao.addBook(b);
////        
////        List<Book> bList = jdbcDao.getBooksByAuthorId(a.getAuthorId());
...
////        jdbcDao.addBook(b1);
////        
////        bList = jdbcDao.getBooksByAuthorId(a.getAuthorId());
...
////        jdbcDao.addBook(b);
////        
////        List<Book> bList = jdbcDao.getBooksByPublisherId(p.getPublisherId());
////        assertEquals(bList.size(), 1);
////        assertTrue(areEqual(bList.get(0), b));
////
////        Book b1 = new Book();
...
////        jdbcDao.addBook(b1);
////        
////        bList = jdbcDao.getBooksByPublisherId(p.getPublisherId());
////        assertEquals(bList.size(), 2);
////    }
    ...
    private boolean areEqual(HBook b1, HBook b2) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        System.out.println("++++++++++++++++++++++++++++++++++++");
        System.out.println(sdf.format(b1.getPublishDate()));
        System.out.println(sdf.format(b2.getPublishDate()));
        System.out.println("++++++++++++++++++++++++++++++++++++");

        return b1.getBookId() == b2.getBookId()
                && b1.getIsbn().equals(b2.getIsbn())
                && b1.getTitle().equals(b2.getTitle())
                && areEqual(b1.getPublisher(), b2.getPublisher())
                && b1.getPrice().equals(b2.getPrice())
                && sdf.format(b1.getPublishDate()).equals(sdf.format(b2.getPublishDate()))
                // FIXME - this is cheap...
