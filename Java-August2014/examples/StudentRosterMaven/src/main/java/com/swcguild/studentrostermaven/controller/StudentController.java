...
public class StudentController {
    ...
    private void addStudent() {
        ...
        temp.setStudentId(io.readString("Please enter student id:"));
        
        dao.addStudent(temp);
    }

    private void getStudentById() {
        Student temp = dao.getStudentById(io.readString("Enter id of student to retrieve:"));
        if (temp != null) {
...
//                .forEach(student -> io.print(student.toString()));
    ...
    private void removeStudent() {
        String studentId = io.readString("Enter the id of the student you wish to remove:");
        dao.removeStudent(studentId);
    }

    private void updateStudent() {
        Student temp = dao.getStudentById(io.readString("Enter the id of the student to edit:"));
        if (temp != null) {
