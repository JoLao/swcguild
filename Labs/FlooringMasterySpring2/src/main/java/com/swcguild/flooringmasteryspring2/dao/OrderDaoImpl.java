...
public class OrderDaoImpl implements OrderDao {
    ...
    private void addOrderFromFile(String orderDate, Order order) {
    ...
    private boolean isOrderFileInArrayList(String fileName) {
...
//        return (orderNumbers.length > 0 ? orderNumbers[orderNumbers.length - 1] : 0);
    ...
    public boolean loadOrdersPerFile(String orderFileName) throws FileNotFoundException {
        ...
        System.out.println("loadOrdersPerFile()........");
...
//        }
    ...
    private boolean savePerFile(String orderFileName) throws IOException {
        boolean isThereData = false;
...
//LaborCost,Tax,Total
    ...
    private void deleteEmptyOrderFile(String fileName) {
