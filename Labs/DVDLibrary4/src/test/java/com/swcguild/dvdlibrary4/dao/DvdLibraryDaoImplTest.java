...
package com.swcguild.dvdlibrary4.dao;

import com.swcguild.dvdlibrary4.ui.DvdLibraryController;
...
public class DvdLibraryDaoImplTest {
    private DvdLibraryDaoImpl test;
    ...
    public void setUp() {
        ...
        test = (DvdLibraryDaoImpl) ctx.getBean("dvdLibraryDaoImpl");
    }
...
//        Collections.sort(dvdOut2);
        ...
        assertTrue(result);
//        assertEquals(dvdList1.size(), dvdOut2.size());
//        
//        for (int i=0; i < dvdList1.size(); i++) {
//            result = dvdList1.get(i).equals(dvdOut2.get(i));
//            assertTrue(result);
//        }
...
//        Collections.sort(dvdOut2);
        ...
        assertTrue(result);
//        assertEquals(dvdList.size(), dvdOut2.size());
//        
//        for (int i=0; i < dvdList.size(); i++) {
//            result = dvdList.get(i).equals(dvdOut2.get(i));
//            assertTrue(result);
//        }
...
//        Collections.sort(dvdList2);
        ...
        try {
            DvdLibraryDaoImpl test2 = new DvdLibraryDaoImpl();
            test2.loadFromFile();
