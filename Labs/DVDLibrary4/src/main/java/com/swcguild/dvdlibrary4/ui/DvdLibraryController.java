package com.swcguild.dvdlibrary4.ui;


import com.swcguild.dvdlibrary4.dao.DvdLibraryDaoImpl;
...
public class DvdLibraryController {
    ...
    private DvdLibraryDaoImpl dvdLibrary;
    private ConsoleIO io = new ConsoleIO();

    public DvdLibraryController(DvdLibraryDaoImpl dvdLibrary) {
...
//        DvdLibraryDaoImpl    dvdLibrary = new DvdLibraryDaoImpl();
//        DvdLibraryController controller = new DvdLibraryController(dvdLibrary);
//        controller.run();
        
        ApplicationContext ctx = new ClassPathXmlApplicationContext("applicationContext.xml");
        DvdLibraryController controller = (DvdLibraryController) ctx.getBean("dvdLibraryController");
        controller.run();
    }
