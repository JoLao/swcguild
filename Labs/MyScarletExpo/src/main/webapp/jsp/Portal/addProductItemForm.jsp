                ...
                <div class="col-xs-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <h2 align="center">Add New Equipment Item to Inventory</h2>
                            <hr />
                            <div style="height: 25px"></div>
                            <sf:form class="form-horizontal" role="form" method="post" action="addProductItem" modelAttribute="productItem">

                                <div class="form-group">                                    
                                    <sf:label path="productItemName" class="col-xs-3 control-label">Equipment Item Name</sf:label>                                     
                                        <div class="col-xs-9">
                                        <sf:input path="productItemName" size="15" class="form-control" placeholder="Equipment Item Name"/>
