                ...
                <div class="col-xs-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <button type="button" class="btn btn-default btn-lg btn-block">View All Events</button>
                            <br />
                            <a href="addEventForm"><button type="button" class="btn btn-default btn-lg btn-block">Add New Event</button></a>
                            <br />
                            <button type="button" class="btn btn-default btn-lg btn-block">Edit Event</button>
                            <br />
                            <button type="button" class="btn btn-default btn-lg btn-block">Remove Event</button>
