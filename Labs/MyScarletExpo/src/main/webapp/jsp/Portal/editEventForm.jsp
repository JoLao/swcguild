                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <sf:form class="form-horizontal" role="form" method="post" action="editEvent" modelAttribute="event">
                                <sf:input type="hidden" path="eventId" value="${userId}" />
                                <div class="form-group">                                    
                                    <sf:label path="eventName" class="col-xs-3 control-label">Event Name</sf:label>                                     
                                        <div class="col-xs-9">
                                        <sf:input path="eventName" size="15" class="form-control" placeholder="Event Name"/>
                                        <sf:errors path="eventName" cssClass="error"></sf:errors>
                                        </div>
                                    </div>
                                    <div class="form-group">                                    
