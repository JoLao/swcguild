                ...
                <div class="col-xs-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <a href="displayProductList"><button type="button" class="btn btn-default btn-lg btn-block">View All Equipment</button></a>
                            <br />
                            <a href="addProductForm"><button type="button" class="btn btn-default btn-lg btn-block">Add New Equipment</button></a>
                            <br />
                            <a href="displayProductList"><button type="button" class="btn btn-default btn-lg btn-block">Edit Equipment</button></a>
                            <br />
                            <a href="displayProductList"><button type="button" class="btn btn-default btn-lg btn-block">Remove Equipment</button></a>
