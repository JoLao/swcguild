                            ...
                            <sf:form class="form-horizontal" role="form" method="post" action="editProductItem" modelAttribute="productItem">
                                ...
                                <div class="form-group">                                    
                                    ...
                                    <div class="col-sm-offset-3 col-sm-9">
                                        <div class="checkbox">
                                                ...
                                                <c:if test="${active == true}">
                                                       <sf:checkbox path="active" value="${active}" checked="checked"/>
                                                </c:if>    
                                            <c:if test="${active == false}">
                                                       <sf:checkbox path="active" value="${active}"/>
                                                </c:if>  
                                                Active
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-3 col-sm-9">
                                            <div class="checkbox">
                                            <sf:label path="damaged">
                                                <input type="checkbox"
                                                <c:if test="${productItemView.lost == true}">checked</c:if>>
                                                Damaged</sf:label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <br />
                                <div align="center">                                    
                                    <a href="displayProductItemList?productId=${productId}">
                                    <button class="btn-lg btn-primary">Back</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
