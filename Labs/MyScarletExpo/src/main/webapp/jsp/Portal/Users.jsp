                ...
                <div class="col-xs-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <a href="displayUserList"><button type="button" class="btn btn-default btn-lg btn-block">View All Users</button></a>
                            <br />
                            <a href="addUserForm"><button type="button" class="btn btn-default btn-lg btn-block">Add New User</button></a>
                            <br />
                            <a href="displayUserList"><button type="button" class="btn btn-default btn-lg btn-block">Edit User</button></a>
                            <br />
                            <a href="displayUserList"><button type="button" class="btn btn-default btn-lg btn-block">Remove User</button></a>
                            <div style="height: 25px"></div>
                        </div>
                    </div>
                </div>
